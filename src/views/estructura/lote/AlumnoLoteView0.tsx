...
function AlumnoLoteView() {	
    let navigate = useNavigate();

    let [titulo] =useState('Alumnos Lote');

    let [module] = useState("estructura");
	let [controller] = useState("alumno_api");
    ...
    const nuevoPreparar = () => {
        ...
        alumno.fecha_nacimiento='2021-01-01';
