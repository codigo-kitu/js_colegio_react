...
type PropsBuscarDocenteMateriaComp = {
	module: string,
	controller: string,
...
function BuscarDocenteMateriaCompBase(props: PropsBuscarDocenteMateriaComp,ref:any): JSX.Element {
	/*
	props: {
		//------------------ ACCIONES -------------------
		module:String,
...
let BuscarDocenteMateriaComp = forwardRef(BuscarDocenteMateriaCompBase);

export {BuscarDocenteMateriaCompBase,BuscarDocenteMateriaComp};