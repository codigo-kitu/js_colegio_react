...
function BuscarPensionCompBase(props: PropsBuscarPensionComp,ref:any): JSX.Element {
	/*
	props: {
		//------------------ ACCIONES -------------------
		module:String,
...
let BuscarPensionComp = forwardRef(BuscarPensionCompBase);

export {BuscarPensionCompBase,BuscarPensionComp};